...
public partial class ext_item_Item_Type_Add : System.Web.UI.Page
{
    #region 網頁屬性
    ...
    private void Save()
    {
            ...
            try
            {
                ...
                returner = entityExtItemType.Add(txtItemType.Text.Trim().ToUpper(), txt_1.Text, txt_2.Text, txt_3.Text, txt_4.Text, txt_5.Text, txt_6.Text, txt_7.Text, txt_8.Text, txt_9.Text, txt_10.Text, txt_11.Text, txt_12.Text, DefVal.Str, DefVal.Str, DefVal.Str, "Y", DateTime.Now, actorSId, DateTime.Now, actorSId);

                //回到前一頁
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Redit", "alert('外銷商品產品別新增成功!!'); location.href='View.aspx';", true);
            }
            finally
            {
                if (returner != null) returner.Dispose();
    ...
    bool CheckInputted()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                string[] conds = new string[1] { txtItemType.Text.Trim().ToUpper() };
                ...
                if (returner.IsCompletedAndContinue)
                {
                    ...
                    {
                        errMsgs.Add("「產品別」：" + txtItemType.Text.Trim().ToUpper() + " 已經存在");
