<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_block.ascx.cs" Inherits="include_client_ext_order_trans_hx_goods_block" %>

<%@ Reference Control="~/include/client/ext/order/trans_hx/goods_item_block.ascx" %>
