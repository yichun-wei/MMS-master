...
public partial class include_client_ext_order_trans_hx_goods_block : System.Web.UI.UserControl
{
    ...
    public void SetInfo(ExtOrderHelper.GoodsEditInfo editInfo)
    {
        ...
        if (editInfo.Items != null && editInfo.Items.Count > 0)
        {
            ...
            {
                var block = (ASP.include_client_ext_order_trans_hx_goods_item_block_ascx)this.LoadControl("~/include/client/ext/order/trans_hx/goods_item_block.ascx");
