<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_block.ascx.cs" Inherits="include_client_ext_order_edit_manual_goods_block" %>

<%@ Reference Control="~/include/client/ext/order/edit/manual/goods_item_block.ascx" %>
