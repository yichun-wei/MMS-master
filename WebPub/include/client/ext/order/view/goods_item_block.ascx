<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_item_block.ascx.cs" Inherits="include_client_ext_order_view_goods_item_block" %>
<tr id="htmlTr" runat="server">
    ...
    <td><asp:Literal ID="litBeforeTransQty" runat="server" /></td>
    <td><asp:Literal ID="litTransQty" runat="server" /></td>
