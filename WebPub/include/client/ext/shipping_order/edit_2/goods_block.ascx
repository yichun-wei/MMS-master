<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_block.ascx.cs" Inherits="include_client_ext_shipping_order_edit_2_goods_block" %>

<%@ Reference Control="~/include/client/ext/shipping_order/edit_2/goods_item_block.ascx" %>

<asp:Panel ID="divGoodsBlock" runat="server">
    <asp:Literal ID="litAnchor" runat="server" />
    <div class="ListTable_title"><asp:Literal ID="litTitle" Text="品項訂單" runat="server" /></div>
