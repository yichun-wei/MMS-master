<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_block.ascx.cs" Inherits="include_client_ext_quotn_readjust_manual_goods_block" %>

<%@ Reference Control="~/include/client/ext/quotn/readjust/manual/goods_item_block.ascx" %>
