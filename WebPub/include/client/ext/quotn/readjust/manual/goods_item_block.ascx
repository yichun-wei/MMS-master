<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_item_block.ascx.cs" Inherits="include_client_ext_quotn_readjust_manual_goods_item_block" %>
<tr id="htmlTr" runat="server">
    <td class="no">
        <asp:Literal ID="litSeqNo" runat="server" /></td>
    <td class="textBox"><asp:TextBox ID="txtModel" TextMode="MultiLine" CssClass="dev-model" runat="server" onkeydown="if(event.keyCode == 13){return false;}" /></td>
    <td></td>
    <td class="number">
