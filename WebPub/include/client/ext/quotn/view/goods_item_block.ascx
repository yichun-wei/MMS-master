<%@ Control Language="C#" AutoEventWireup="true" CodeFile="goods_item_block.ascx.cs" Inherits="include_client_ext_quotn_view_goods_item_block" %>
<tr>
    ...
    <td class="number"><asp:Literal ID="litQty" runat="server" /></td>
    <td><asp:Literal ID="litUnitPrice" runat="server" /></td>
    <td class="discount"><asp:Literal ID="litDiscount" runat="server" /></td>
