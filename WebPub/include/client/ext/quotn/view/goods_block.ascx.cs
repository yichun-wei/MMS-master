...
public partial class include_client_ext_quotn_view_goods_block : System.Web.UI.UserControl
{
    ...
    public void SetInfo(ExtOrderHelper.GoodsEditInfo editInfo)
    {
        ...
        if (editInfo.Items != null && editInfo.Items.Count > 0)
        {
            ...
            {
                var block = (ASP.include_client_ext_quotn_view_goods_item_block_ascx)this.LoadControl("~/include/client/ext/quotn/view/goods_item_block.ascx");
