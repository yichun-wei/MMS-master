<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/client.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="ext_quotn_index" %>
    ...
    <div id="center">
        ...
        <div class="searchBox">
            <table class="form">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtBeginQuotnDate" CssClass="checkin dev-date-all" runat="server" />
                        ~
                        <asp:TextBox ID="txtEndQuotnDate" CssClass="checkin dev-date-all" runat="server" />
                    </td>
                </tr>
                <tr>
                    <th>建單人：</th>
                    <td>
                        <asp:DropDownList ID="lstCreaterList" runat="server">
                            <asp:ListItem Text="全部" Value="" />
                        </asp:DropDownList>
                    </td>
                    <th>預計交貨日：</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:CheckBoxList ID="chklKeywordCols" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
                            <asp:ListItem Value="ODR_NO" Text="報價單編號" Selected="true" />
            ...
            <div class="btnBox searchBtn">
                <div>
                    <div>
                        <asp:Button ID="btnSearch" Text="搜尋報價單" runat="server" OnClick="Page_DoSearch" />
        ...
        <div class="list_box">
            <div class="btnBox">
                <div>
                    <div>
                        <asp:HyperLink ID="lnkAdd" Text="新增報價單" runat="server" /></div>
                </div>
            </div>
