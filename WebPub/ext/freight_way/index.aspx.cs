...
public partial class ext_freight_way_index : System.Web.UI.Page
{
    #region 網頁屬性
    string AUTH_CODE = "EXT_FREIGHT_WAY";
    string AUTH_NAME = "外銷貨運方式";
    ...
    int _useTgt = (int)PubCat.UseTgtOpt.ExtFreightWay;
    ...
    private bool InitPage()
    {
        ...
        this.PageTitle = "外銷貨運方式";

        //麵包屑
        List<string> breadcrumbs = new List<string>();
        breadcrumbs.Add(string.Format("<a href='{0}sys_user/index.aspx'>後端管理</a>", SystemDefine.WebSiteRoot));
        breadcrumbs.Add(string.Format("<a href='{0}'>外銷貨運方式</a>", QueryStringParsing.CurrentRelativeUri.OriginalString));
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        this.WebPg.AdditionalClickToDisableScript(this.btnUpdateSort);
        ...
        if (systemIds.Length > 0)
        {
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required))
                {
                    ...
                    {
                        returner = entityPubCat.GetFreightWayUseInfo(sid);
