<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/client.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="ext_freight_way_index" %>
    ...
    <div id="center">
        ...
        <div class="rondane_box">
            <div class="btnBox">
                <div>
                    <div>
                        <asp:LinkButton ID="btnAdd" Text="新增" runat="server" /></div>
                    <div>
                        <asp:LinkButton ID="btnDelete" Text="刪除" runat="server" OnClick="btnDelete_Click" /></div>
                    <div>
                        <asp:LinkButton ID="btnUpdateSort" Text="修改排序" runat="server" /></div>
                </div>
            </div>
