<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/client_popup.master" AutoEventWireup="true" CodeFile="det_goods.aspx.cs" Inherits="popup_ext_shipping_order_det_goods" %>
        ...
        <div class="searchBox">
            <table class="form">
            	<tr>
                    ...
                    <td colspan="2"><asp:TextBox ID="txtKeyword" runat="server" /></td>
                </tr>
                <tr>
                    <th>分類查詢：</th>
                    <td>
