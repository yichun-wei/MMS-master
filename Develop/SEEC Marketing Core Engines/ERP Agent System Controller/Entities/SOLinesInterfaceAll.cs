...
namespace Seec.Marketing.Erp.SystemEngines
{
    public partial class DBTableDefine
    {
        ...
        /// </summary>
        public const string SO_LINES_INTERFACE_ALL = "OE.SO_LINES_INTERFACE_ALL";
    }

    /// <summary>
    /// SO-LINES-INTERFACE-ALL。
    /// </summary>
    public class SOLinesInterfaceAll : SystemBase
    {
        /// <summary>
        /// 初始化 Seec.Marketing.Erp.SystemEngines.SOLinesInterfaceAll 類別的新執行個體。
        /// </summary>
        /// <param name="connInfo">資料庫連線資訊。</param>
        public SOLinesInterfaceAll(string connInfo)
            : base(EntityHelper.GetEntityBase(connInfo, DBTableDefine.SO_LINES_INTERFACE_ALL))
        {
        ...
        /// 表格資料。
        /// </summary>
        public class Info : ISOLinesInterfaceAll
        {
            /// <summary>
            /// SYSDATE。
            /// </summary>
            ...
            /// 明細項次。
            /// </summary>
            [SchemaMapping(Name = "LINE_NUMBER", Type = ReturnType.Int)]
            public int LineNumber { get; set; }
            /// <summary>
            /// 常數：REGULAR。
            /// </summary>
            [SchemaMapping(Name = "LINE_TYPE", Type = ReturnType.String)]
            public string LineType { get; set; }
            /// <summary>
            /// 常數：EA。
            /// </summary>
            [SchemaMapping(Name = "UNIT_CODE", Type = ReturnType.String)]
            public string UnitCode { get; set; }
            /// <summary>
            /// 訂單數量。
            /// </summary>
            [SchemaMapping(Name = "ORDERED_QUANTITY", Type = ReturnType.Int)]
            public int OrderedQuantity { get; set; }
            /// <summary>
            /// 訂單日期。
            /// </summary>
            [SchemaMapping(Name = "DATE_REQUESTED_CURRENT", Type = ReturnType.DateTimeFormat, AllowNull = true)]
            ...
            /// 預計出貨日(內外銷都相同規則)。
            /// </summary>
            [SchemaMapping(Name = "SCHEDULED_SHIPMENT_DATE", Type = ReturnType.DateTimeFormat, AllowNull = true)]
            ...
            /// 常數：Y。
            /// </summary>
            [SchemaMapping(Name = "CALCULATE_PRICE", Type = ReturnType.String)]
            ...
            /// 客戶 ID。
            /// </summary>
            [SchemaMapping(Name = "SHIP_TO_CUSTOMER_ID", Type = ReturnType.Long, AllowNull = true)]
        ...
        public Returner Add(ISOLinesInterfaceAll info)
        {
            ...
            try
            {
                ...
                transSet.SmartAdd("LINE_NUMBER", info.LineNumber, GenericDBType.Int);
                transSet.SmartAdd("LINE_TYPE", info.LineType, GenericDBType.VarChar, false);
                transSet.SmartAdd("UNIT_CODE", info.UnitCode, GenericDBType.VarChar, false);
                transSet.SmartAdd("ORDERED_QUANTITY", info.OrderedQuantity, GenericDBType.Int);
                transSet.SmartAdd("DATE_REQUESTED_CURRENT", info.DateRequestedCurrent, string.Empty, GenericDBType.DateTime, true);
                transSet.SmartAdd("INVENTORY_ITEM_ID", info.InventoryItemId, GenericDBType.BigInt, true);
                transSet.SmartAdd("SCHEDULED_SHIPMENT_DATE", info.ScheduledShipmentDate, string.Empty, GenericDBType.DateTime, true);
                transSet.SmartAdd("WAREHOUSE_ID", info.WarehouseId, GenericDBType.Int, true);
                transSet.SmartAdd("ATTRIBUTE2", info.Attribute2, GenericDBType.VarChar, true, true);
                transSet.SmartAdd("CALCULATE_PRICE", info.CalculatePrice, GenericDBType.VarChar, true, true);
                transSet.SmartAdd("ORDER_SOURCE_ID", info.OrderSourceId, GenericDBType.Int);
                transSet.SmartAdd("SHIP_TO_CUSTOMER_ID", info.ShipToCustomerId, GenericDBType.BigInt, true);
                //[20160421 by 米雪]
