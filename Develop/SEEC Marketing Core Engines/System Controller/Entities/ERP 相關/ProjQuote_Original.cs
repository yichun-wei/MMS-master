...
namespace Seec.Marketing.SystemEngines
{
    ...
    public class ProjQuote : SystemBase
    {
        ...
        public Returner Add(string quoteId, string quoteNumber, DateTime quoteDate, string quoteTitle, string remark, string flowStatus, string quoteItemId, string productId, float unitPrice, int quantity, float discount, string dealerCustomerId, string dealerErpNum, string dealerErpName)
        {
        ...
        /// <exception cref="System.ArgumentNullException">參數 quoteNumber 不允許為 null 值。</exception>
        /// <exception cref="System.ArgumentNullException">參數 quoteItemId 不允許為 null 值。</exception>
        public Returner Modify(string quoteNumber, string quoteItemId, string quoteId, DateTime quoteDate, string quoteTitle, string remark, string flowStatus, string productId, float unitPrice, int quantity, float discount, string dealerCustomerId, string dealerErpNum, string dealerErpName)
        {
            if (quoteNumber == null) { throw new ArgumentNullException("quoteNumber"); }
            if (quoteItemId == null) { throw new ArgumentNullException("quoteItemId"); }
